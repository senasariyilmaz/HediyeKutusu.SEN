<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucProduct.ascx.cs" Inherits="SEN.Presentation.ucProduct" %>
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
<div class="section clearfix">
    <div class="col-md-12">
        <div class="row ">
            <div class="row shop_box-top">
                <asp:DataList ID="dlstUrunler" runat="server" DataKeyField="urunid" RepeatColumns="4" OnItemCommand="dlstUrunler_ItemCommand">
                    <ItemTemplate>
